...
public class MnistToDataStreamer {
	...
	/**
	 * Uses default values for max saturation = 255, INPUT Length = 784 and OUTPUT Length = 10
	 * @param imgFile
	 * @param lblFile
	 * @return
	 ...
	 * @throws IOException
	 */
	public static DataStreamer createStreamer(String imgFile, String lblFile) throws FileNotFoundException, IOException {
	 ...
	 * @param imgFile
	 * @param lblFile
	 * @param maxValue = of saturation to normalise values between 0 and 1 (set to 1 to not normalise)
	 * @param featureLength = length of feature vector (usually flattened to 784)
	 * @return
	 * @throws FileNotFoundException
	 * @throws IOException
	 */
	public static DataStreamer createStreamer(String imgFile, String lblFile, float maxValue, int featureLength) throws FileNotFoundException, IOException {
